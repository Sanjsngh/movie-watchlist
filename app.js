...
searchBtn.addEventListener('click', (e) => {
    ...
    fetch(url) // Returns promise
        ...
        .then(data => { // Resolving using .then methond again
            console.log(data);
            const moviesData = data.Search; // 10 movies data
            displayEl.innerHTML = '';
            ...
            for(let i = 0; i < 3; i++){
                ...
                fetch(movieUrl)
                    ...
                    .then(data => {
                            ...
                            <div class="movie-item">
                                ...
                                <div class="info-right">
                                    ...
                                    <div class="info--second">
                                        ...
                                        <small>${Genre}</small>
                                        <span>
                                            <i class="fa fa-plus" onclick="addMoviesToLocalStorage('${imdbID}')"></i>Watchlist
                                        </span>
                                    </div>
                        ...
                        // addMoviesToLocalStorage(tt72882)
                        // addMoviesToLocalStorage('tt72882')
                        // allImdbIds.push(imdbID);
                        // // console.log(addBtns); 
                        // // addBtns[addBtns.length-1].addEventListener('click', () => addMoviesToLocalStorage(imdbID));
                        // if(i === 2){
                        //     const addBtns = document.querySelectorAll('.fa-plus');
                        //     for(let j = 0; j < addBtns.length; j++){
                        //         addBtns[j].addEventListener('click', () => addMoviesToLocalStorage(allImdbIds[j]));
                        //     }
                        // }
                    })
            }
